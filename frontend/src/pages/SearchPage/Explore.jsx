...
const Explore = () => {
  ...
  return (
    <div className=" w-full  p-3 xl:hidden   gap-3 flex flex-col  h-[70vh]">
      {/* Full screen Display */}

      <FullScreen
        imgDetails={fullImageUri}
        setFullScreen={setFullScreen}
        isFullScreen={isFullScreen}
      />
      {/* search box  */}
      <div className="flex px-3  mx-auto w-full   flex-col  gap-2 py-2">
          ...
          <div className=" w-full  h-fit mt-3 flex justify-between items-center">
            ...
            <div>
              <p className="text-[10px] font-bold ">
                {storage != "" ? storage.results?.length : "0"} Rendered Images
              </p>
            </div>
          </div>
        )}
      ...
      {isLoading ? (
        <img
          ref={lodAnim}
          src="loading.png"
          className="w-[50px]  mx-auto mt-10 mb-10 "
        />
      ) : storage == "" ? (
        ...
        <div className="outputs px-5 py-3  flex-wrap h-full  gap-1 overflow-hidden block  overflow-x-scroll overflow-y-scroll columns-auto ">
          {storage.results?.map(
      ...
      {storage.total_pages == pageNum
        ? ""
        : storage != "" && (
            <div className="flex  mx-auto w-full px-5 flex-col  gap-2 py-2 justify-center items-center">
